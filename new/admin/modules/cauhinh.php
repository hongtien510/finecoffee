...
<table width="95%" border="1" cellspacing="0" cellpadding="0">
	...
	<tr>
		<th width="200" align="right" valign="middle" scope="row">Link Facebook : </th>
		<td width="494">
			<label>
				<input class="input_style3" type="text" name="linkfacebook" size="50" id="linkfacebook" value="<?php echo $r['linkfb'] ?>" />
			</label>
		</td>
	</tr>

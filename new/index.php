<?php
	define('BASE_URL', 'http://localhost/finecoffee/new/');
	//define('BASE_URL', "http://ishalimedia.com/finecoffee/");	
	include('libs/db_connect.php'); 
	include('libs/hamhaydung.php'); 
	
	$sql_info = "Select * from cauhinh";
	$rs_info=mysql_query($sql_info);
	$info=mysql_fetch_assoc($rs_info);
        ...
        <div id="con_left">
        	<ul class="menu_left">
                ...
                <li class="parent_left_menu li_lmenu_take"><a href="<?php echo BASE_URL?>takeaway.html"><p class="lmenu_take name_parent_menu">TAKE AWAY</p></a></li>
               	<li class="parent_left_menu li_lmenu_face"><a href="<?php echo $info['linkfb']; ?>" target="_blank"><p class="lmenu_face name_parent_menu">FOLLOW US ON FACEBOOK</p></a></li>
            </ul>
            <div class="facebook">
				<iframe src="//www.facebook.com/plugins/likebox.php?href=<?php echo $info['linkfb'] ?>&amp;width=235&amp;height=255&amp;show_faces=true&amp;colorscheme=light&amp;stream=false&amp;show_border=false&amp;header=false&amp;appId=340376799398737" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:235px; height:255px;" allowTransparency="true"></iframe>
            </div>
        </div>
        <div id="con_right">		
			<?php					
